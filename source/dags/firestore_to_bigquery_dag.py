...
def run_firestore_to_gcs():
    subprocess.run(['python3', '/home/airflow/gcs/dags/firestore_to_gcs.py', DAG_BUCKET], check=True)

# Task 2: Transform and load data into BigQuery
def run_transform_and_load():
    subprocess.run(['python3', '/home/airflow/gcs/dags/transform_and_load.py'], check=True)
